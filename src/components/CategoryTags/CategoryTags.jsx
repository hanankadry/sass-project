...
import useApi from "../../auth/api/useApi/useApi";
    ...
    <>
      ...
      <ul className="sm:flex hidden mt-8 flex-wrap gap-4 font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
        <li className="me-2">
          <NavLink
            to="/"
            className="inline-block pillLink px-4 py-2 border transition-all hover:shadow-xl shadow duration-300 rounded-full hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300"
          >
            All
          </NavLink>
        </li>
        {categories.map((cat) => (
          <li className="me-2" key={cat.strCategory}>
            <NavLink
              ...
              className="inline-block px-4 py-2 pillLink border-gray-400 border transition-all hover:shadow-xl shadow duration-300  rounded-full hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300"
            >
              {cat.strCategory}
            </NavLink>
          </li>
